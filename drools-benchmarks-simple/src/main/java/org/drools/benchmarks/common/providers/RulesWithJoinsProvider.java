...
public class RulesWithJoinsProvider implements DRLProvider {
    ...
    private boolean withGeneratedConsequence = false;
...
//        System.out.println(drlBuilder.toString());
    ...
    private String getJoinConstraints(int index) {
        String pattern1 = "  not " + (char)('B'+index) + "( value < $" + (char)('a'+index) + ".value )\n";
        String pattern2 = "  $" + (char)('b'+index) + " : " + (char)('B'+index) + "( value " + joinConstraintValueOperator + " $" + (char)('a'+index) + ".value )\n";
