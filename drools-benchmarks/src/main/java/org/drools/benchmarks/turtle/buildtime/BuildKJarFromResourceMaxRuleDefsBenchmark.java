...
public class BuildKJarFromResourceMaxRuleDefsBenchmark {
    ...
    @Param({"10", "100", "1000"})
    private String maxRuleDefs;

    private Resource drlResource;

    @Setup
    public void createResource() {
        System.setProperty("drools.evaluationContext.maxRuleDefs", maxRuleDefs);
        System.setProperty("drools.predicateInformation.maxRuleDefs", maxRuleDefs);
