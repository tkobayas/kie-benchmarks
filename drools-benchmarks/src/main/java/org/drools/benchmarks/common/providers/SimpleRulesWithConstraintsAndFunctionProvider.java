...
public class SimpleRulesWithConstraintsAndFunctionProvider implements DRLProvider {
    ...
    public SimpleRulesWithConstraintsAndFunctionProvider(final String constraints, final String consequence, int numberOfFunctions, String returnStatement) {
    ...
    public String getDrl(int numberOfRules, String ruleNameBase) {
        ...
        for (int i = 0; i < numberOfFunctions; i++) {
            drlBuilder.append("function int myFunction" + i + "() {\n");
            drlBuilder.append(returnStatement.replace("${i}", String.valueOf(i)) + "\n");
            drlBuilder.append("}\n");
        }
        drlBuilder.append("\n");
