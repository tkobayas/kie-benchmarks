...
public class AlphaNodeRangeIndexingTraversalBenchmark extends AbstractBenchmark {
    ...
    public void generateFacts() {
        // Just one fact which matches traversalPercentage of rules
    ...
    public int test(final Blackhole eater) {
        ...
        //System.out.println("\n  fired = " + fired);
        //System.out.println("    ratio = " + ((double)fired / sinkNum));
        return fired;
    }
}
